...
//     async getSubmissionsByStatus(status:string):Promise<{submissions?: ISubmission[], hasError: boolean, status?: number}>{
//       try {
//         const { data } = await bigApi().get('get-submissions/?status=' + status);
//         return {submissions: data.data,
//                 hasError: false,};
...
//     async getTakenSubmissionsByStatus(status:string):Promise<{submissions?: ISubmission[], hasError: boolean, status?: number}>{
//       try {
//         const { data } = await bigApi().get('get-taken-submissions/?status=' + status);
//         return {submissions: data.data,
//                 hasError: false,};
...
//     async getPendingSubmissions():Promise<{submissions?: ISubmission[], hasError: boolean, status?: number}>{
